...
-- Created on Mon Feb 25 04:45:04 2013
-- 
;
--
-- Table: service.
...
CREATE TABLE "service_credential" (
  ...
  CONSTRAINT "sc_service_credential_id_user_id_idx2" UNIQUE ("user_id", "service_id", "service_credential_id")
);
...
CREATE TABLE "oauth2_credential" (
  ...
  CONSTRAINT "oauth2_credential_service_credential_id" UNIQUE ("service_credential_id")
);
